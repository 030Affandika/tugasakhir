...
<body>
    ...
    <form action="http://localhost/SIMPEGDLHP/backend/fungsi/upload.php" method="POST" enctype="multipart/form-data">
        ...
        <label for="file_kartu_keluarga">Kartu BPJS:</label><br>
        <input type="file" name="file_kartu_bpjs" required><br><br>

        <!-- Upload Surat Nikah -->
        <label for="file_surat_nikah">Surat Persetujuan Pensiun:</label><br>
        <input type="file" name="file_surat_persetujuan_pensiun" required><br><br>
