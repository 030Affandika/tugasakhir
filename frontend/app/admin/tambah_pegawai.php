...
<body>
    ...
    <form method="POST" action="/SIMPEGDLHP/backend/fungsi/adminpegawai.php" enctype="multipart/form-data">
        <div>
            <label for="nama" class="block font-medium text-gray-700">Nama:</label>
            <input type="text" id="nama" name="nama" required 
                class="w-full px-3 py-2 border border-black rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
        ...
        <div>
            <button type="submit" name="tambah_pegawai" 
                class="px-4 py-2 font-semibold text-white bg-green-600 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                Tambah Pegawai
            </button>
        </div>
    </form>
